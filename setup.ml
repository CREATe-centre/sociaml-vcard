...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8c8277777a0404094d55e56f4ba840f1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/dominicjprice/sociaml-vcard";
          synopsis = "vCard library for OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "Library for parsing and creating contact information in the vCard format. Currently only version 4.0 of the vCard specification is supported."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Lexer"; "Parser"; "Printer"; "Syntax"; "Vcard_4_0"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "sociaml_vcard";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/sociaml-vcard";
                      doc_title = "sociaml-vcard Reference";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dominicjprice/sociaml-vcard.git";
                      src_repo_browser =
                        Some "https://github.com/dominicjprice/sociaml-vcard";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "îZ¢\022\017icjüX~Ló\127×\021";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
