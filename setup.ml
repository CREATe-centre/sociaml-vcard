...
(* OASIS_START *)
(* DO NOT EDIT (digest: ee010f9f8950a16e1fc499374999bf14) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some [OASISText.Para "Parse and write vCard data in OCaml"];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "vcard"];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "ocamldoc";
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\007\241\023\001\158\187;!\023\187?\169\203\210\201\231";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
